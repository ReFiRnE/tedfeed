...
- (void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI
 qualifiedName:(NSString *)qualifiedName attributes:(NSDictionary *)attributeDict{
    ...
    if ([elementName isEqualToString:@"item"]) {
        self.currentItem = [[[Ted alloc]init]autorelease];
    }else if ([elementName isEqualToString:@"media:thumbnail"]) {
        self.currentItem.videoUrl = [attributeDict valueForKey:@"url"];
    }else if ([elementName isEqualToString:@"itunes:image"]) {
        self.currentItem.imageUrl = [attributeDict valueForKey:@"href"];
